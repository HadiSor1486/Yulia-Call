...
.stream-title{
  ...
  /* Title sits in its own gradient strip at the top of the video */
...
function streamHandleState(state) {
  ...
  // v3.31: bring controls back into view briefly on every state change
  // so users see the new state (e.g. paused indicator). Auto-hide kicks
  // in 2.5s later if the video is playing.
