...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════ */
.zomb-ovl{position:fixed;inset:0;z-index:230;background:radial-gradient(ellipse at center,#3d1a4a 0%,#1a0a26 70%,#000 100%);display:none;flex-direction:column;animation:fadeIn .2s}
.zomb-ovl.show{display:flex}
.zomb-ovl:not(.show){contain:strict;pointer-events:none}
.zomb-ovl::before{content:'';position:absolute;inset:0;background-image:radial-gradient(circle at 25% 30%,rgba(255,255,255,0.025) 0%,transparent 40%),radial-gradient(circle at 75% 70%,rgba(255,255,255,0.025) 0%,transparent 40%);pointer-events:none}
...
.zomb-hand .zomb-card{margin-left:-26px;transition:transform .18s,margin-left .2s}
.zomb-hand .zomb-card:first-child{margin-left:0}
...
function zombRenderHand() {
  ...
  if (!el) return;
  el.innerHTML = '';
  zombCli.hand.forEach(card => {
    el.appendChild(zombBuildCard(card, { back: false }));
  });
}
